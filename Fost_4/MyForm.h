...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			chartArea1->AxisX->Title = L"Âðåìÿ t";
			...
			chartArea1->AxisY->Title = L"Ñêîðîñòü V";
			...
			title1->Text = L"Ãðàôèê çàâèñèìîñòè V îò t";
			this->chart1->Titles->Add(title1);
			// 
			// chart2
			// 
			chartArea2->AxisX->Minimum = 0;
			chartArea2->AxisX->Title = L"Âðåìÿ t";
			...
			chartArea2->AxisY->Title = L"Âûñîòà H";
			...
			title2->Text = L"Ãðàôèê çàâèñèìîñòè H îò t";
...
#pragma endregion
		const double p0 = 1.27; // ïëîòíîñòü âáëèçè ïîâåðõíîñòè Çåìëè
		const double beta = -2.3026; // áåòà èç ìåòîäè÷êè
		const double g = 9.8; // êîýô. ñâîáîäíîãî ïàäåíèÿ
		const double v_ = 7800;	// ïåðâàÿ êîñìè÷åñêàÿ ñêîðîñòü
		const double h_ = 17000; // 17êì èç ìåòîäè÷êè
