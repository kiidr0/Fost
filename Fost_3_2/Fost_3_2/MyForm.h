...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Задание номер 2";
			...
			chartArea3->AxisY->Title = L"Скорость V, м/с";
			...
			title3->Text = L"График зависимости v от t";
			...
			chartArea4->AxisX->TitleFont = (gcnew System::Drawing::Font(L"Times New Roman", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			chartArea4->AxisY->Title = L"Высота полета H, м";
			...
			title4->Text = L"График зависимости h от t";
			...
			this->ClientSize = System::Drawing::Size(394, 771);
...
#pragma endregion
		...
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			double V0, H0, k, V, Vt, t, m, y, h, p, c, a, b;

			const double dt = 0.2;

			V0 = 0;
			m = 64;
			h = 1.53; // радиус парашюта
			p = 1.29;
			c = 1.33; // коэфф лобового столкновения
			H0 = 0;

			V = V0;
			y = H0;
			k = 0.5 * pi * h * h * c * p; // коэф. квадратичной составляющей скорости
